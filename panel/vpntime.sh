...
verb 3" > /etc/openvpn/client-common.txt
	...
	echo ""
        arquivo=($CLIENT.ovpn)
        mv /root/$arquivo /root/arquivosopenvpn
	...
	echo ""
        ...
        arquivo=($CLIENT.ovpn)
        rm /root/arquivosopenvpn/$arquivo
