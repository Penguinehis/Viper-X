#!/bin/bash
clear
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%30s%s%-10s\n' " Alterar a data de validade dos usuarios " ; tput sgr0 ; echo ""
...
if [ -a /tmp/exp ]
then
	tput setaf 2 ; tput bold ; echo "Para remover todos usuarios Expirados use a opcao 7 no painel" ; echo "" ; tput sgr0
	rm /tmp/exp
fi
